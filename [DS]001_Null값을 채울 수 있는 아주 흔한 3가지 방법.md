...
![DS 002](https://user-images.githubusercontent.com/60219074/74584403-44fa2180-5015-11ea-84ca-db68f3724a2a.jpg)
뿔뿔히 흩어진 데이터를 모아서 종합 한 후에 결측치가 어디에 있는지, 열마다 얼마나 있는지를 파악한다. 그 후에 과연 결측치가 있는 열이 데이터 분석 목적과 연관성이 있는지에 대해 상관관계분석을 통해 살펴볼 필요가 있다. 상관관계 여부에 따라 결측치를 채우거나 지우면 된다.
